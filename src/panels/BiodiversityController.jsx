...
import { Button, Typography, Tab, Tabs, Box, Icon, IconButton } from '@material-ui/core';

import { MuiThemeProvider, createTheme } from '@material-ui/core/styles';
import indigo from '@material-ui/core/colors/indigo';

import emitter from '@utils/events.utils';
import { ACCESS_TOKEN, SENSOR_API_URL } from '@/config';
            ...
            return (
                <>
                    <Button
                        ...
                        color="primary"
                        style={styles.button}
                        onClick={() => this.handleCalculate(`${SENSOR_API_URL}/api/shannon`, 'shannonIndex')}
                        disabled={loading}
                    >
            ...
            return (
                <>
                    <Button
                        ...
                        color="primary"
                        style={styles.button}
                        onClick={() => this.handleCalculate(`${SENSOR_API_URL}/api/chao1`, 'chao1Index')}
                        disabled={loading}
                    >
            ...
            return (
                <>
                    <Button
                        ...
                        color="primary"
                        style={styles.button}
                        onClick={() => this.handleCalculate(`${SENSOR_API_URL}/api/chao2`, 'chao2Index')}
                        disabled={loading}
                    >
