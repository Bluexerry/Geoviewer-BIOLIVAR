...
class Navigator extends React.Component {
    ...
    componentDidMount() {
        this._handleSetLoginState = (e) => this.setState({ loggedin: e });
        emitter.addListener('setLoginState', this._handleSetLoginState);
        emitter.on('handleToken', this.handleToken);
    }

    componentWillUnmount() {
        emitter.removeListener('setLoginState', this._handleSetLoginState);
        emitter.removeListener('handleToken', this.handleToken);
    }
